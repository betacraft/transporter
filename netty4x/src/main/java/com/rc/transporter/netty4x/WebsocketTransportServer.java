 ...
 * Time  : 8:52 PM
 */
public abstract class WebsocketTransportServer {
    /**
     ...
     */
    public interface INettyWebsocketTransportSessionFactory {
        INettyWebsocketTransportSession get ();
    }

    /**
     * Constructor for the server with shutdown hook to cleanup properly before process shutsdown
     */
    protected WebsocketTransportServer () {
    ...
    public abstract void start (final int port,
            ...
            final INettyWebsocketTransportSession transportSession)
            throws Exception;
    ...
    public abstract void start (final int port,
            final ITransportServerListener transportServerListener,
            final INettyWebsocketTransportSessionFactory
